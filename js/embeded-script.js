...
function fncLocalemitFlash(_tttt, _eeee, _r, _n, _o, _a) {
...
function fncLocalemitRemoved(_tttt, _eeee, _r, _n, _o, _a) {
...
function fncLocalemitEndtext(_tttt, _eeee, _r, _n, _o, _a) {
...
function fncLocalemitAdded(_tttt, _eeee, _r, _n, _o, _a) {
...
function localemit(_tttt, _eeee, _r, _n, _o, _a) {
  ...
  switch( _tttt ) {
  case "flash":
    fncLocalemitFlash(_tttt, _eeee, _r, _n, _o, _a);
    break;
  case "removed":
    // レスポンスイベント
    fncLocalemitRemoved(_tttt, _eeee, _r, _n, _o, _a);
    break;
  case "endText":
    fncLocalemitEndtext(_tttt, _eeee, _r, _n, _o, _a);
    break;
  case "added":
    fncLocalemitAdded(_tttt, _eeee, _r, _n, _o, _a);
    break;
  default:
    break;
  }
